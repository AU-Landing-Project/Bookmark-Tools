...
//		elgg_register_plugin_hook_handler("register", "menu:title", "bookmark_tools_title_menu_register_hook");
//		elgg_register_plugin_hook_handler("widget_url", "widget_manager", "bookmark_tools_widget_url_hook");
